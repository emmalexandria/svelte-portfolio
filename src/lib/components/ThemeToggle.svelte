...
<label class="inline-flex items-center cursor-pointer">
    ...
    peer-checked:after:start-auto after:border-thin after:border-mono-950 dark:after:border-mono-50 after:box-border after:rounded-large after:h-4 after:w-4
    after:transition-all peer-checked:bg-primary-600 dark:peer-checked:bg-primary-400"
	></div>
	<span
