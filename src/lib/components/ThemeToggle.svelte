...
<label class="inline-flex items-center cursor-pointer">
	...
	/>
	<div
		class="relative shadow-hard-low w-12 h-6 box-border bg-mono-50 dark:bg-mono-950 outline-none border border-mono-950 dark:border-mono-50 rounded-large peer
	...
	></div>
	<span class="ml-2 text-mono-950 dark:text-mono-50 transition-all">{@render children()}</span>
</label>
